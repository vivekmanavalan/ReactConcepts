...
const ParentComponent = () => {
    ...
    //used the useCallback because everytime when we change the state of the salary or age the 
    //component gets re-rendered and even when one state is changed both the functions are called 
    //once automatically to avoid that we use usecallback
